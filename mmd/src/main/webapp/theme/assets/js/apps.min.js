...
var handlePanelAction = function () {
    ...
    $("[data-click=panel-collapse]").hover(function () {
        $(this).tooltip({title: "展开/收起", placement: "bottom", trigger: "hover", container: "body"});
        $(this).tooltip("show")
    });
    ...
    $("[data-click=panel-reload]").hover(function () {
        $(this).tooltip({title: "重载", placement: "bottom", trigger: "hover", container: "body"});
        $(this).tooltip("show")
    });
    ...
    $("[data-click=panel-expand]").hover(function () {
        $(this).tooltip({title: "最大化/还原", placement: "bottom", trigger: "hover", container: "body"});
        $(this).tooltip("show")
    });
