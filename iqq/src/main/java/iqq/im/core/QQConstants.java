...
public interface QQConstants {
    ...
    /**
     * Constant <code>REFFER="http://s.web2.qq.com/proxy.html?v=20130916001&callback=1&id=1"{trunked}</code>
     */
    public static final String REFFER = "http://s.web2.qq.com/proxy.html?v=20130916001&callback=1&id=1";
    /**
     * Constant <code>REFFER="http://d1.web2.qq.com/proxy.html?v=20151105001&callback=1&id=2"{trunked}</code>
     */
    public static final String NEW_REFERER = "http://d1.web2.qq.com/proxy.html?v=20151105001&callback=1&id=2";
    ...
    /**
     * Constant <code>URL_GET_VF_WEBQQ="http://s.web2.qq.com/api/getvfwebqq"</code>
     */
    public static final String URL_GET_VF_WEBQQ = "http://s.web2.qq.com/api/getvfwebqq";
    /**
    ...
    /**
     * Constant <code>URL_GET_SELF_INFO="http://s.web2.qq.com/api/get_self_info2"{trunked}</code>
     */
    ...
    /**
     * Constant <code>URL_GET_ONLINE_BUDDY_LIST="http://d1.web2.qq.com/channel/get_online_buddies2"{trunked}</code>
     */
    public static final String URL_GET_ONLINE_BUDDY_LIST = "http://d1.web2.qq.com/channel/get_online_buddies2";
    /**
     * Constant <code>URL_SEND_BUDDY_MSG="http://d1.web2.qq.com/channel/send_buddy_msg2"{trunked}</code>
     */
    public static final String URL_SEND_BUDDY_MSG = "http://d1.web2.qq.com/channel/send_buddy_msg2";
    /**
     * Constant <code>URL_SEND_GROUP_MSG="http://d1.web2.qq.com/channel/send_qun_msg2"{trunked}</code>
     */
    public static final String URL_SEND_GROUP_MSG = "http://d1.web2.qq.com/channel/send_qun_msg2";
    /**
     * Constant <code>URL_SEND_DISCUZ_MSG="http://d1.web2.qq.com/channel/send_discu_msg2"{trunked}</code>
     */
    ...
    /**
     * Constant <code>URL_CHANGE_STATUS="http://d1.web2.qq.com/channel/change_status2"{trunked}</code>
     */
    ...
    /**
     * Constant <code>URL_GET_DISCUZ_INFO="http://d1.web2.qq.com/channel/get_discu_info"{trunked}</code>
     */
    public static final String URL_GET_DISCUZ_INFO = "http://d1.web2.qq.com/channel/get_discu_info";
    /**
     * Constant <code>URL_GET_RECENT_LIST="http://d1.web2.qq.com/channel/get_recent_list2"{trunked}</code>
     */
